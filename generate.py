...
INFO = [
    ...
    ("blank",),
    ("section", "Projects"),
    ("kv",  ["CAA"],                       "Corporate Actions Agent (LangGraph)"),
    ("kv",  ["Flow-Seeker"],               "Agentic chatbot · conditional routing"),
    ("kv",  ["Repo-Stream"],               "Kafka + PySpark streaming pipeline"),
    ("kv",  ["FinPlay"],                   "End-to-end fintech · Rust · React"),
    ("blank",),
    ("section", "Contact"),
